...
$::version  = 'v0.3.0 based on wifky-1.6.0_1';
...
$::print    = ' 'x 10000; $::print = '';
%::config   = ( crypt => '' , sitename => 'markdowned wifky!' , preview_style => 0 );
%::flag     = ();
%::cnt      = ();
...
sub init_globals{
    ...
    @::copyright = (
        qq(Generated by <a href="https://github.com/hymkor/markdowned_wifky">markdowned_wifky</a> $::version with Perl $])
    );
